...
module.exports = class MonsterGame {
  ...
  // List monsters
  listMonsters = () => {this.monsters.forEach((Monster) => console.log(`Monster: ${Monster.monsterName}, Minimum Life: ${Monster.minimumLife}, Current Life: ${Monster.currentLife}, Still Alive?: ${Monster.isAlive}`))}
  ...
  updateLife = (lifeChangeAmount = 0) =>
    this.monsters.forEach((monster) => monster.updateLife(lifeChangeAmount));
